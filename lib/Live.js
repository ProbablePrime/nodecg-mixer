...
var WsabiClient = require('wsabi-client').WsabiClient;
var WsabiSocket = require('wsabi-client').WsabiSocket;

WsabiSocket.WebSocket = require('ws');
WsabiSocket.Promise = require('bluebird');
...
Live.prototype.registerEvent  = function(type, eventName,id,channel) {
	...
	this.wsabi.live(slugString).subscribe(this.onUpdate.bind(this, slugString,channel));
};
